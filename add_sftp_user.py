...
with open('./adduser', 'w') as f:
    ...
    f.write('\nsudo chown root:root /home/sftp-root/%s' % (userName))
    f.write('\nsudo chown %s:%s /home/sftp-root/%s/Incoming' % (userName, userName, userName))
    f.write('\nsudo chown %s:%s /home/sftp-root/%s/Outgoing' % (userName, userName, userName))
